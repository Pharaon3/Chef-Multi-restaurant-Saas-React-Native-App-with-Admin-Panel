...
class addNewItem extends Component {
    ...
    submitHandler = () => {
        ...
        if(!errors.length){
            ...
            this.props.createOrUpdateItem(data,UserData.token_type+" "+UserData.token,'UPDATE')
    ...
    componentWillMount(){
        ...
        if(filtered.length){
            let category_name = this.props.categories.filter(category=>
                category.id == filtered[0].category_id
            )
            ...
            this.setState({
                ...
                item_category_name:category_name[0].name,
                item_category_id:filtered[0].category_id,
                description:filtered[0].description,
                cooking_time:filtered[0].cooking_time,
                is_recommended:filtered[0].is_recommended,
                is_veg:filtered[0].is_veg
            })
        }
    }
    render() {
                ...
                >
                   ...
                   <Input
                    ...
                    number
                     ...
                     defaultValue={this.state.price!=null?this.state.price.toString():null}
