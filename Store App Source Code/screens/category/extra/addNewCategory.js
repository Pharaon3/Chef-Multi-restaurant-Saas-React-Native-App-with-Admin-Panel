...
import {addNewCategory} from '../../controller/actions/inventoryActions'
...
class addItem extends Component {
    ...
    submitHandler = () => {
        ...
        if(!errors.length){
            ...
            this.props.addNewCategory(data,UserData.token_type+" "+UserData.token)
        }
    }
...
export default connect(mapSateToProps,{userData,fetchStore,addNewMessage,updateStore,clearAllMessages,addNewCategory}) (addItem);
